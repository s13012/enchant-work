 ...
 * @type {Object}
 */
enchant.ui = { assets: ['assets/pad.png', 'assets/apad.png', 'assets/icon0.png', 'assets/font0.png'] };
...
enchant.ui.Pad = enchant.Class.create(enchant.Sprite, {
    ...
    initialize: function() {
        ...
        var image = core.assets['assets/pad.png'];
...
enchant.ui.MutableText = enchant.Class.create(enchant.Sprite, {
    ...
    setText: function(txt) {
        ...
        for (i = 0; i < txt.length; i++) {
            ...
            this.image.draw(enchant.Game.instance.assets['assets/font0.png'],
