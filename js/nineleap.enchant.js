...
(function() {
     ...
     * @type {Object}
     */
    enchant.nineleap = { assets: ['assets/start.png', 'assets/end.png'] };
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets['assets/start.png'];
                ...
                this.endScene.image = this.assets['assets/end.png'];
